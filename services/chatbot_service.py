...
class ChatbotService:
    ...
    STAMP_CODES = {
        'regret': {
            'R_1': {'name': '미련 별', 'situation': '꿈/진로 포기, 기회 상실', 'keywords': ['꿈', '진로', '포기', '기회', '상실', '도전', '미래', '목표', '학자', '연구', '학문'], 'mean': '잃어버린 꿈의 흔적들이 별빛처럼 남아있다는 뜻이다. 그 미련은 네게 다음 항로를 안내하는 빛이 될 것이다.'},
            'R_2': {'name': '침묵 끝', 'situation': '잘못된 말/행동, 사과하지 못한 일', 'keywords': ['말', '행동', '사과', '잘못', '실수', '미안', '후회', '상처', '표현'], 'mean': '하지 못한 말이 쌓여 결국 단절을 초래했음을 보여준다. 침묵의 끝에서 비로소 너의 진심이 시작될 수 있지.'},
            'R_3': {'name': '단절 선', 'situation': '관계 단절, 소중한 사람 놓친 후회', 'keywords': ['관계', '단절', '소중한', '사람', '놓친', '친구', '가족', '이별', '멀어', '연락'], 'mean': '관계의 끈이 끊어진 지점은 선명하게 남아있다. 그 선은 관계의 끝이 아니라, 네가 새로운 연결을 시작해야 할 기준선이다.'},
            'R_4': {'name': '공전 멈춤', 'situation': '게으름, 자기 관리 실패 (시간 낭비 등)', 'keywords': ['게으름', '관리', '실패', '시간', '낭비', '자책', '노력', '건강', '외모'], 'mean': '스스로 정한 궤도에서 멈춰선 상태를 의미한다. 다시 움직이는 것은 외부의 힘이 아니라, 너의 의지에 달려 있지.'}
        },
        'love': {
            'L_1': {'name': '스침 빛', 'situation': '놓친 인연', 'keywords': ['놓친', '인연', '타이밍', '기회', '만남', '스쳐', '운명'], 'mean': '짧은 스침 속에서도 인연의 빛이 교차했음을 보여준다. 그 짧은 빛이 네 마음에 남긴 따뜻한 흔적을 기억하라.'},
            'L_2': {'name': '봉오리 마음', 'situation': '짝사랑', 'keywords': ['짝사랑', '좋아', '고백', '못한', '혼자', '마음', '첫사랑', '썸'], 'mean': '아직 피지 못한 채 웅크리고 있는 너의 마음이다. 그 마음이 열릴 때 비로소 관계는 시작될 수 있지.'},
            'L_3': {'name': '정지 시간', 'situation': '이별', 'keywords': ['이별', '헤어', '끝', '떠나', '차', '버림', '작별', '무뚝뚝'], 'mean': '이별의 순간에 시간이 멈춘 듯한 감각을 담고 있다. 멈춘 시간을 인정해야만 다시 흐르는 시간을 마주할 수 있다.'},
            'L_4': {'name': '균열 복원', 'situation': '신뢰', 'keywords': ['신뢰', '믿음', '배신', '거짓말', '약속', '바람', '외도'], 'mean': '깨진 신뢰의 틈을 다시 잇고자 하는 너의 의지이다. 복원은 시간이 아니라 노력을 통해 완성되는 것이다.'},
            'L_5': {'name': '엇갈림 실', 'situation': '오해', 'keywords': ['오해', '갈등', '다툼', '싸움', '의견', '충돌'], 'mean': '소통의 실타래가 잘못 꼬여버린 순간을 기록한다. 실이 엉켰음을 인정해야만 다시 풀 수 있는 법이지.'},
            'L_6': {'name': '반복 틈', 'situation': '권태', 'keywords': ['권태', '지루', '식', '무관심', '반복', '싫증'], 'mean': '지루한 일상 속에서 관계가 멈춰버린 틈을 보여준다. 그 틈을 메울 새로운 시도야말로 다음 단계의 열쇠가 된다.'}
        },
        'dream': {
            'D_1': {'name': '흐릿 길', 'situation': '꿈/방향성 상실, 무기력, 번아웃', 'keywords': ['방향', '상실', '무기력', '번아웃', '모르', '길', '목표', '없', '찾'], 'mean': '방향을 잃고 안개 속에 갇혀버린 너의 상태를 나타낸다. 흐릿하더라도 한 걸음 내딛는 것이 정지하는 것보다 명확한 선택이다.'},
            'D_2': {'name': '현실 벽', 'situation': '현실적 제약 (돈/시간), 주변의 반대', 'keywords': ['현실', '돈', '시간', '제약', '반대', '여건', '경제', '부모', '가난'], 'mean': '이상과 현실 사이에 가로막힌 거대한 장애물이다. 벽의 높이를 재지 말고, 벽을 우회할 논리적인 경로를 찾아라.'},
            'D_3': {'name': '두려움 극복', 'situation': '실패/재능에 대한 두려움, 용기 부족', 'keywords': ['실패', '두려', '용기', '재능', '없', '못', '불안', '겁', '무서'], 'mean': '실패가 두려워 움츠러든 너의 모습이다. 두려움은 필연적이다. 그 필연성을 인정하고 다음 도전을 실행하라.'},
            'D_4': {'name': '공허 정상', 'situation': '꿈 성취 후의 허무함, 목표 상실', 'keywords': ['성취', '허무', '권태', '목표', '잃', '이룬', '후', '달성', '공허'], 'mean': '정점에 도달했지만 허무함만 남은 너의 상태를 기록한다. 다음 목표를 설정하는 것이야말로 이 공허를 메울 유일한 방법이다.'},
            'D_5': {'name': '내면 빛', 'situation': '자아실현, 내적 성장에 대한 꿈', 'keywords': ['자아', '성장', '내적', '의미', '가치', '진짜', '본질', '자기'], 'mean': '외부의 시선이 아닌, 너 자신의 가치와 의미를 찾아가는 여정이다. 진정한 빛은 안에서부터 시작되는 법이지.'}
        },
        'anxiety': {
            'A_1': {'name': '연결 끈', 'situation': '인간 관계에 대한 불안', 'keywords': ['관계', '사람', '대인', '친구', '외로', '거부', '혼자'], 'mean': '관계의 끈이 끊어질까 봐 느끼는 너의 불안이다. 끈을 놓지 않으려는 집착보다, 끈의 강도를 키우는 것에 집중하라.'},
            'A_2': {'name': '갈림 판단', 'situation': '선택에 대한 불안', 'keywords': ['선택', '결정', '갈림', '고민', '어떻게', '판단', '길'], 'mean': '수많은 갈림길 앞에서 너의 논리적 판단이 마비된 상태이다. 최선의 길보다, 최선의 노력을 다할 길을 선택하자.'},
            'A_3': {'name': '성과 짐', 'situation': '일(학업)에 대한 불안', 'keywords': ['일', '학업', '성적', '직장', '업무', '공부', '시험', '과제', '성과'], 'mean': '성과에 대한 외부의 압박이 너의 어깨를 짓누르는 상태이다. 짐의 무게를 재지 말고, 짐을 효율적으로 옮길 방법을 찾아라.'},
            'A_4': {'name': '존재 탐구', 'situation': '정체성(삶의 방향)에 대한 불안', 'keywords': ['정체성', '삶', '방향', '나', '존재', '의미', '누구', '어디'], 'mean': '자신이 누구인지, 어떤 의미를 가지고 있는지 끊임없이 묻는 너의 질문이다. 답을 찾으려 하지 말고, 질문 자체가 너의 존재임을 받아들여라.'}
        }
    }
    ...
    def generate_response(self, user_message: str, username: str = "방문자") -> dict:
        ...
        if session.awaiting_letter_confirm:
            if self._detect_letter_confirm_yes(user_message):
                ...
                # 우표 정보 가져오기
                stamp_info = self._get_stamp_info(stamp_code)
                stamp_msg = f"자 너의 편지에 붙어 있었던 우표다. {stamp_info['mean']}"
...
"""
            ...
            try:
                ...
                if session.drawer_conversation_count >= MIN_DRAWER_CONVERSATIONS:
                    ...
                    # 우표 설명 메시지
                    stamp_message = f"자 너의 편지에 붙어 있었던 우표다. {stamp_info['mean']}"
        ...
        if session.phase == 5:
            ...
            if any(keyword in user_message for keyword in ["편지", "열", "보여", "읽"]):
                if session.letter_content:
                    stamp_code = session.selected_drawer if session.selected_drawer else self._determine_stamp_code(session)
                    stamp_info = self._get_stamp_info(stamp_code)
                    stamp_message = f"좋아. 다시 한번 보여주지. 자 너의 편지에 붙어 있었던 우표다. {stamp_info['mean']}"
                    session.add_message("assistant", stamp_message)
                    self._save_session(session)
